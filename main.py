...
# Load logo image                  #I commited out all the image code for background image because it couldn't find the file no matter what I did
...
# Create widgets
#background_label = tk.Label(frame, Image.open("logo.png"), bg="#333333") # this was crashing the program, it can't find the image file for logo.
